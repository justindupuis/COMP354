...
public class SSGUI implements ActionListener{
	...
	public SSGUI(){
		...
		tblGrid = new SSTable();//uses the default values on load
		...
		txtMessageBox = new JTextField("Welcome to Team 3!");
		...
		//Setup center panel
		tblGrid.setPreferredSize(new Dimension(this.intScreenWidth,this.intScreenHeight));
